...
'You are successfully running web2py': 'Você esta rodando corretamente o web2py',
'You are successfully running web2py.': 'Você esta rodando corretamente o web2py.',
'You can modify this application and adapt it to your needs': 'Você pode modificar esta aplicação conforme suas necessidades',
